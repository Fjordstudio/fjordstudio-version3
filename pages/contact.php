...
// 				$result = $objConnection->query($sql);
				...
				echo "<h3>Thank you for reaching out.</h3><p>I'll get back to you as soon as possible.<br>Have a lovely day.</p>";
		...
		?>
			...
			<div>
				<div>
					<div class="logo-grid social-grid">
						<a href="https://www.facebook.com/km.llywelyn" title="My Facebook profile" target="_blank">
							<img src="https://fjordstudio.dk/assets/img/icons/fb.png" alt="">
						</a>
						<a href="https://twitter.com/Fjordscene" title="My Twitter account" target="_blank">
							<img src="https://fjordstudio.dk/assets/img/icons/tw.png" alt="">
						</a>
						<a href="https://linkedin.com/in/katrine-marie/" title="My LinkedIn account" target="_blank">
							<img src="https://fjordstudio.dk/assets/img/icons/li.png" alt="">
						</a>
					</div>
					<p>
						You can also locate me on one of my social media accounts - I watch them carefully although I don't necessarily post much. I shall spare you my objections over how time-consuming these sites are, and simply tell you that I do not access them from my phone. Ever. For the sake of my sanity. So if you do contact me through one of these channels, do expect a certain delay before I can respond. Be assured though that I will.
					</p>
					<p>
